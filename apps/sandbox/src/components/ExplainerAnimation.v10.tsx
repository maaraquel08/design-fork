...
/**
 * ExplainerAnimation v10 - Clean Architecture
 *
 * Key improvements:
      ...
      <div className="bg-[#262626] border border-[#2f2f2f] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden pointer-events-auto transition-all duration-200 rounded-xl">
        {!state.isOpen ? (
          ...
          >
            ...
            <span className="text-[#a3a3a3] whitespace-nowrap text-xs">V2</span>
          </button>
        ) : (
...
const ANIMATION_TIMELINE: TimelineAction[] = [
  ...
  {
    type: "setState",
    changes: { uifork: { isOpen: true, hoveredVersion: null, versions: ["v1", "v2", "v3"] } },
  },
  { type: "wait", duration: 300 },

  // ─────────────────────────────────────────────────────────────────────────────
  // 2. Hover over v3 version
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Hovering over v3" },
  { type: "moveTo", target: '[data-version="v3"]', duration: 500 },
  {
    type: "setState",
    changes: { uifork: { isOpen: true, hoveredVersion: "v3", versions: ["v1", "v2", "v3"] } },
  },
  { type: "wait", duration: 500 },

  // ─────────────────────────────────────────────────────────────────────────────
  // 3. Click fork button on v3
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Clicking fork button" },
  { type: "moveTo", target: '[data-fork-button="v3"]', duration: 400 },
  { type: "wait", duration: 200 },
  { type: "click" },

  // ─────────────────────────────────────────────────────────────────────────────
  // 4. v4 file appears in code editor sidebar
  // ─────────────────────────────────────────────────────────────────────────────
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 5. v4 version appears in UIFork dropdown
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "v4 appears in UIFork" },
  {
    type: "setState",
    changes: {
      uifork: { isOpen: true, hoveredVersion: null, versions: ["v1", "v2", "v3", "v4"] },
    },
  },
  { type: "wait", duration: 500 },

  // ─────────────────────────────────────────────────────────────────────────────
  // 6. Move cursor to code editor and click v4 file
  // ─────────────────────────────────────────────────────────────────────────────
...
export default function ExplainerAnimation() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full aspect-video bg-muted rounded-lg border border-border p-4 overflow-hidden relative"
    >
