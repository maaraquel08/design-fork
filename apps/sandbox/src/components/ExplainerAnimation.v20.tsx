...
function DashboardContent({ version }: { version: string }) {
        ...
        return (
          <div className="flex-1 overflow-auto">
            ...
            <div className="px-6 py-4">
              <div className="w-full h-10 bg-white dark:bg-stone-800 border border-border rounded-lg" />
            </div>
            ...
            <div className="px-6 pb-6 flex gap-6">
              ...
              <div className="w-2/3 space-y-4">
                {/* Large card */}
                <div className="h-48 bg-white dark:bg-stone-800 border border-border rounded-lg" />
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-24 bg-white dark:bg-stone-800 border border-border rounded-lg"
                    />
                  ))}
                </div>
              </div>
              ...
              <div className="w-1/3 space-y-4">
                {/* Card */}
                <div className="h-32 bg-white dark:bg-stone-800 border border-border rounded-lg" />
                ...
                <div className="space-y-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-12 bg-white dark:bg-stone-800 border border-border rounded-lg"
                    />
                  ))}
                </div>
              </div>
  ...
  return (
    <div className="min-h-full bg-stone-50 dark:bg-stone-950 flex flex-col">
      {/* Navbar */}
      <div className="h-14 border-b border-border flex items-center justify-between px-6 shrink-0">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            {["Home", "Discover", "Projects"].map((link) => (
              <div key={link} className="h-4 w-16 bg-muted rounded" />
            ))}
          </div>
        </div>
