...
function DashboardContent({ version }: { version: string }) {
  // Different content layouts for each version (below the tabs)
...
const ANIMATION_TIMELINE: TimelineAction[] = [
  ...
  // 9. Delete some rows
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Deleting rows" },
  { type: "deleteRows", count: 3 },
  { type: "wait", duration: 400 },

  // ─────────────────────────────────────────────────────────────────────────────
  // 10. Add new rows
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Adding new rows" },
  { type: "addRows", count: 4 },
  { type: "wait", duration: 400 },

  // ─────────────────────────────────────────────────────────────────────────────
  // 11. Save file (circle returns to X, browser updates to v4 layout)
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Saving file" },
  { type: "wait", duration: 300 },
  {
    type: "setState",
    changes: {
  ...
  // 15. Click v4 again
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Clicking v4 again" },
  { type: "moveTo", target: '[data-version="v4"]', duration: 400 },
