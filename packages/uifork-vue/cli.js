...
function showHelp() {
  console.log(`
uifork-vue - A CLI tool for managing Vue component versions

Usage:
  uifork-vue <component-path>                         Initialize a new forked component (shorthand)
  uifork-vue init <component-path>                    Initialize a new forked component (explicit)
  uifork-vue watch [directory] [--port <port>]         Watch for version changes (defaults to current directory)
  uifork-vue new <component-path> [version-id]        Create a new version
  uifork-vue fork <component-path> <version-id> [target-version]  Fork/duplicate a version
  uifork-vue rename <component-path> <version-id> <new-version-id>  Rename a version
  uifork-vue delete <component-path> <version-id>    Delete a version
  uifork-vue promote <component-path> <version-id>   Promote a version to be the main component

Examples:
  uifork-vue frontend/src/SomeDropdownComponent.vue
  uifork-vue init frontend/src/SomeDropdownComponent.vue
  uifork-vue watch
  uifork-vue watch ./src
  uifork-vue watch --port 3002
  uifork-vue watch ./src --port 3002
  uifork-vue new SomeDropdownComponent
  uifork-vue new SomeDropdownComponent v3
  uifork-vue fork SomeDropdownComponent v1 v2
  uifork-vue rename SomeDropdownComponent v1 v2
  uifork-vue delete SomeDropdownComponent v2
  uifork-vue promote SomeDropdownComponent v2
...
function showVersion() {
  ...
  console.log(`uifork-vue v${packageJson.version}`);
}
...
if (command && !knownCommands.includes(command)) {
  ...
  try {
    ...
    console.error(
      "Usage: uifork-vue <component-path> or uifork-vue init <component-path>",
    );
    console.error(
      "Example: uifork-vue frontend/src/components/ContactCard.vue",
    );
    process.exit(1);
  }
  process.exit(0);
...
switch (command) {
  case "init":
    if (!argument) {
      ...
      console.error("Usage: uifork-vue <component-path> or uifork-vue init <component-path>");
      console.error(
        "Example: uifork-vue frontend/src/components/ContactCard.vue",
      );
      console.error(
        "Example: uifork-vue init frontend/src/components/ContactCard.vue",
      );
      process.exit(1);
    }
  ...
  case "promote":
    if (!argument) {
      ...
      console.error("Usage: uifork-vue promote <component-path> <version-id>");
      console.error("Example: uifork-vue promote SomeDropdownComponent v2");
      console.error("Example: uifork-vue promote frontend/src/SomeDropdownComponent.vue v1_2");
      process.exit(1);
    }
  ...
  case "create":
    if (!argument) {
      ...
      console.error("Usage: uifork-vue new <component-path> [version-id]");
      console.error("Example: uifork-vue new SomeDropdownComponent");
      console.error("Example: uifork-vue new SomeDropdownComponent v3");
      process.exit(1);
    }
    ...
    try {
      ...
      const finalFilePath = path.join(
        manager.watchDir,
        `${manager.componentName}.v${fileVersion}.vue`,
      );
      ...
      const templateContent = `<script setup lang="ts">
...
`;
  ...
  case "duplicate":
    if (!argument) {
      ...
      console.error("Usage: uifork-vue fork <component-path> <version-id> [target-version]");
      console.error("Example: uifork-vue fork SomeDropdownComponent v1");
      console.error("Example: uifork-vue fork SomeDropdownComponent v1 v2");
      process.exit(1);
    }
  ...
  case "rename":
    if (!argument) {
      ...
      console.error("Usage: uifork-vue rename <component-path> <version-id> <new-version-id>");
      console.error("Example: uifork-vue rename SomeDropdownComponent v1 v2");
      process.exit(1);
    }
    ...
    try {
      ...
      const finalTargetPath = path.join(
        manager.watchDir,
        `${manager.componentName}.v${targetFileVersion}.vue`,
      );
  ...
  case "delete":
    if (!argument) {
      console.error("Error: Component path and version ID are required");
      console.error("Usage: uifork-vue delete <component-path> <version-id>");
      console.error("Example: uifork-vue delete SomeDropdownComponent v2");
      process.exit(1);
    }
  ...
  default:
    if (!command) {
      ...
      console.error('Run "uifork-vue --help" for available commands');
      process.exit(1);
    }
}
